...
class MapFilterDialog extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return _mapFileterDialog();
  }
}

class _mapFileterDialog extends State<MapFilterDialog> {
  late MapFilter mapFilter;

  final List<DropdownMenuItem<String>> _buildingDownMenuItems = [
    const DropdownMenuItem<String>(value: '1', child: Text('1동')),
  ...
  final List<DropdownMenuItem<String>> _peopleDownMenuItems = [
    const DropdownMenuItem<String>(value: '0', child: Text('전부')),
    const DropdownMenuItem<String>(value: '100', child: Text('100세대 이상')),
    const DropdownMenuItem<String>(value: '300', child: Text('300세대 이상')),
    const DropdownMenuItem<String>(value: '500', child: Text('500세대 이상')),
  ];

  final List<DropdownMenuItem<String>> _carDownMenuItems = [
    const DropdownMenuItem<String>(value: '1', child: Text('세대별 1대 미만')),
    const DropdownMenuItem<String>(value: '2', child: Text('세대별 1대 이상')),
  ];
